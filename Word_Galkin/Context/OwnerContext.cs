...
using Word_Galkin.Models;
using Microsoft.Office.Interop.Word;
using System.Windows.Controls;
using System.Windows.Media.Imaging;

namespace Word_Galkin.Context
{
    public class OwnerContext : Owner
    {
        ...
        public static void Cell(string Text, Microsoft.Office.Interop.Word.Range Cell, WdParagraphAlignment alignment = WdParagraphAlignment.wdAlignParagraphCenter)
        {
            Cell.Text = Text;
